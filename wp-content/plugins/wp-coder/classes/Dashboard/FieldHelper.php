...
class FieldHelper {
	...
	public static function icon_type() {
		return [
			...
			'img'     => __( 'Image', 'floating-button' ),
			'emoji'   => __( 'Emoji', 'floating-button' ),
			'class'   => __( 'Icon Class', 'floating-button' ),
		];
	}
	...
	public static function btn_size() {
		return [
			...
			'flBtn-custom'      => __( 'Custom', 'floating-button' ),
		];
	}
	...
	public static function btn_animation() {
		return [
			...
			'flBtn-effect-rotate'                 => __( 'Rotate', 'floating-button' ),
			'flBtn-effect-scale'                  => __( 'Scale', 'floating-button' ),
			'flBtn-effect-rotate-scale'           => __( 'Rotate and Scale', 'floating-button' ),
			'flBtn-effect-translate'              => __( 'Translate', 'floating-button' ),
			'flBtn-effect-rotate-translate'       => __( 'Translate Rotate', 'floating-button' ),
			'flBtn-effect-rotate-translate-scale' => __( 'Rotate Translate Scale', 'floating-button' ),
			'flBtn-effect-translate-scale'        => __( 'Translate Scale', 'floating-button' ),
		];
	}
	...
	public static function user_roles(): array {
		$add_users      = array( 'all' => array( 'name' => __( 'All Users', 'wpcoder' ) ) );
